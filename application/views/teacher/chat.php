...
<section class="content">
    <div class="row">
     <div class="col-xs-6">
            <form role="form" action="<?php echo base_url();?>teacher/update_chat" method="post">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" name="tujuan" placeholder="To:">
              </div>
              </div>
              <div class="box-body">
              <div class="form-group">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="item">
                 ...
                 <div class="pull-right box-tools">
                  <?php if($_SESSION['sesiteacher']['username'] == $c->username){ ?>
                   <a class='btn btn-danger btn-sm' href="<?php echo base_url("index.php/teacher/delete_chat/"); ?>/<?php echo $c->id;?>">
