...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>A</b>ELG</span>

      <span class="logo-lg"><b>Admin</b>El-goritma</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets_admin');?>/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets_admin');?>/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets_admin');?>/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
        ...
        <li class="treeview">
          <a href="#">
           ...
           <ul class="treeview-menu">
            <li><a href="<?php echo base_url('administrator/dosen');?>"><i class="fa fa-circle-o"></i>Management Dosen</a></li>
            <li><a href="<?php echo base_url('administrator/student');?>"><i class="fa fa-circle-o"></i> Management MHS</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
