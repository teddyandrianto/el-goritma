        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Input student</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url();?>" method="post">
              <div class="box-body">
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_depan" name="nama_depan" placeholder="Enter email">
                </div>
                <div class="form-group">
                  <label for="exampleInputNama">Nama Belakang</label>
                  <input type="text" class="form-control" id="nama_belakang" name="nama_belakang" placeholder="Enter email">
                </div>
                <div class="form-group">
